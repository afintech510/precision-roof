...
const ROUTES: string[] = [
  ...
  '/gallery/',
  '/resources/',
  '/resources/how-to-spot-a-roof-leak/',
  '/resources/huntington-reroof-permit-guide/',
  '/resources/asphalt-vs-metal-roofing-suffolk-county/',
  '/resources/roof-replacement-cost-suffolk-county/',
  '/accessibility/',
  '/estimate/',
  '/areas/',
  '/areas/huntington/',
